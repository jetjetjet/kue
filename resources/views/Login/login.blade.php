            ...
            <form class="text-left" name="form" action="{{ url('/login') }}" method="POST" autocomplete="off">
              <div class="form">
                <div id="username-field" class="field-wrapper input">
                  ...
                  <input id="username" name="username" value="superadmin" value="{{ old('username') }}" type="text" class="form-control" placeholder="Username">
                </div>
                ...
                <div id="password-field" class="field-wrapper input mb-2">
                  ...
                  <input id="password" name="password" value="superadmin" type="password" class="form-control" placeholder="Kata Sandi">
