...
@section('breadcumb')
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"  aria-current="page"><a href="javascript:void(0);">Menu</a></li>
  </ol>
@endsection
  ...
  <script>
    $(document).ready(function (){
        ...
        buttons: {
            buttons: [{ 
              ...
              action: function ( e, dt, node, config ) {
                window.location = "{{ url('/menu/detail') }}";
              }
            }]
        },
        "processing": false,
      ...
      $('#grid').on('click', 'a.gridEdit', function (e) {
        ...
        window.location = "{{ url('/menu/detail') . '/' }}" + rowData.id;
    });
