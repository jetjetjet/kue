...
@section('breadcumb')
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"  aria-current="page"><a href="javascript:void(0);">Pengeluaran</a></li>
  </ol>
@endsection
    ...
    $(document).ready(function (){
      let grid = $('#grid').DataTable({
        ajax: {
          ...
          buttons: {
            buttons: [{ 
              text: "Buat Pengeluaran",
              className: 'btn',
              action: function ( e, dt, node, config ) {
                window.location = "{{ url('/pengeluaran/detail') }}";
              }
            }]
        },
        "processing": false,
        ...
        columns: [
          ...
          { 
            ...
            return formatter.format(data.expenseprice);
          }
          },
          { 
              data: 'expensedateraw',
          ...
          { 
            ...
            render: function(data, type, full, meta){
              ...
              if(data.can_delete && data.expenseexecutedat == null)
